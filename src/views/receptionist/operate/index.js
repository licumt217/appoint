...
import {addReceptionist, updateReceptionist} from "../../../http/service";
...
class Index extends Component {
    ...
    operate = (form) => {
        ...
        if (this.isEdit) {
            updateReceptionist(this.state.formItem).then((data) => {
            ...
            addReceptionist(this.state.formItem).then((data) => {
